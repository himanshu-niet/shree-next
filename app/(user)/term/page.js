...
<dd className='faq-a'>• Bunkar Banaras offers a platform for purchasing fashion products and related
services.
<br/>• Products and services are available within India only.
<br/>• Bunkar Banaras reserves the right to modify or discontinue any service without
notice.</dd>
...
<br/>• Bunkar Banaras is not responsible for the quality, safety, or legality of products and
services.</dd>
...
<br/>• Bunkar Banaras reserves the right to suspend or terminate accounts for violations of
these rules.</dd>
...
<br/>• Bunkar Banaras may moderate and remove content that violates policies.
<br/>• Users retain the rights to their content but grant Bunkar Banaras a non-exclusive,
...
<dd className='faq-a'>• Bunkar Banaras makes no warranties regarding product quality, fitness for a
particular purpose, or accuracy of product descriptions.
<br/>• Bunkar Banaras is not liable for any direct, indirect, or consequential damages arising
from the use of the platform.</dd>



<dt className='faq-q'>7. Selling</dt>
<dd className='faq-a'>• Sellers on Bunkar Banaras are required to provide accurate product descriptions and
prices.
<br/>• Sellers must ensure the availability of listed products.
<br/>• Bunkar Banaras may limit or prohibit sales by sellers who violate policies.</dd>


<dt className='faq-q'>8. Payment</dt>
<dd className='faq-a'>• Payment processing is facilitated by authorized payment gateways.
<br/>• Bunkar Banaras ensures secure transactions but is not responsible for any financial
data breach.</dd>


<dt className='faq-q'>9. E-Platform for Communication</dt>
<dd className='faq-a'>• Users consent to receive communication from Bunkar Banaras electronically.
<br/>• Emails, SMS, or notifications on the platform may be used for communication
purposes.</dd>

<dt className='faq-q'>10. Indemnity</dt>
<dd className='faq-a'>• Users agree to indemnify and hold Bunkar Banaras, its affiliates, and employees
...
<dd className='faq-a'>• All content on the Bunkar Banaras website, including logos and trademarks, is
protected by copyright laws.
<br/>• Unauthorized use of this content is prohibited.</dd>


<dt className='faq-q'>12. Limitation of Liability</dt>
<dd className='faq-a'>• Bunkar Banaras's liability is limited to the amount paid by the user for the product or
service in question.
<br/>• Bunkar Banaras is not responsible for any indirect or consequential losses.</dd>


<dt className='faq-q'>13. Termination</dt>
<dd className='faq-a'>• Bunkar Banaras reserves the right to terminate user accounts at its discretion.
...
<dd className='faq-a'>• Bunkar Banaras operates under the jurisdiction of Indian law.
...
<br/>• Bunkar Banaras is not responsible for the actions or responses of sellers.</dd>
...
<br/>• Bunkar Banaras is not liable for any inaccuracies or errors in this information.</dd>

<dt className='faq-q'>18. Alteration Services</dt>
<dd className='faq-a'>• Bunkar Banaras may provide alteration services, subject to terms and conditions.
...
<dd className='faq-a'>• Bunkar Banaras may charge a convenience fee for specific services.
